    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="开始日期" style="width: 308px">
                <el-date-picker v-model="daterangeStartDate" value-format="YYYY-MM-DD" type="daterange"
                    range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
            </el-form-item>
            <el-form-item label="结束日期" style="width: 308px">
                <el-date-picker v-model="daterangeEndDate" value-format="YYYY-MM-DD" type="daterange"
                    range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="warning" plain icon="Download" @click="handleExport"
                    v-hasPermi="['baseInfo:projectInfo:export']">导出</el-button>
            </el-col>
...
import { listProjectInfo, getProjectInfo, delProjectInfo, addProjectInfo, updateProjectInfo } from "@/api/baseInfo/projectInfo";
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除项目维护编号为"' + _ids + '"的数据项？').then(function () {
...
function handleExport() {
    proxy.download('baseInfo/projectInfo/export', {
        ...queryParams.value
