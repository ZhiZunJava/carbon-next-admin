            ...
            <splitpanes :horizontal="appStore.device === 'mobile'" class="default-theme">
                <pane size="16">
                    <el-col>
                        ...
                        <div class="head-container">
                            <el-tree :data="materialCategoryOptions"
                    ...
                    <el-col>
                        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch"
                            ...
                            <el-form-item label="单位" prop="unit">
                                <el-input v-model="queryParams.unit" placeholder="请输入单位" clearable
                                    @keyup.enter="handleQuery" />
                            </el-form-item>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="materialInfoRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="分类编号" prop="categoryId">
                    <el-tree-select v-model="form.categoryId" :data="materialCategoryOptions"
                        :props="{ value: 'id', label: 'name', children: 'children' }" value-key="id"
                        placeholder="请选择分类编号" check-strictly />
                </el-form-item>
                <el-form-item label="物料编码" prop="code">
...
import { listMaterialInfo, getMaterialInfo, delMaterialInfo, addMaterialInfo, updateMaterialInfo } from "@/api/material/materialInfo";
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除物料档案编号为"' + _ids + '"的数据项？').then(function () {
...
function handleExport() {
    proxy.download('material/materialInfo/export', {
        ...queryParams.value
