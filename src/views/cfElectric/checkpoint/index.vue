<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="98px">
            ...
            <el-form-item label="状态" prop="status">
                <el-select v-model="queryParams.status" placeholder="请选择状态" clearable>
                    <el-option v-for="dict in overload_status" :key="dict.value" :label="dict.label"
                        :value="dict.value" />
                </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="warning" plain icon="Download" @click="handleExport"
                    v-hasPermi="['cfElectric:checkpoint:export']">导出</el-button>
            </el-col>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="checkpointRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="检测点名称" prop="name">
                ...
                <el-form-item label="状态" prop="status">
                    <el-radio-group v-model="form.status">
                        <el-radio v-for="dict in overload_status" :key="dict.value"
...
import { listCheckpoint, getCheckpoint, delCheckpoint, addCheckpoint, updateCheckpoint } from "@/api/cfElectric/checkpoint";
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除能效预警编号为"' + _ids + '"的数据项？').then(function () {
...
function handleExport() {
    proxy.download('cfElectric/checkpoint/export', {
        ...queryParams.value
